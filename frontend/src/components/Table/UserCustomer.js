import { listcustomers } from "../../api/UserApi";
...
const UserCustomer = () => {
    ...
    useEffect(()=>{
        const fetchData = async (page) => {
            try{
                const response = await listcustomers({page});
        ...
        <>
            ...
            <div className="relative overflow-x-auto shadow-md sm:rounded-lg">               
                ...
                <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                    ...
                    <tbody>
                        {useProfile && useProfile.map((user)=>(
                            <tr key={user.username} className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                                ...
                                <th scope="row" className="flex items-center px-6 py-4 text-gray-900 whitespace-nowrap ">
                                    ...
                                    <div className="pl-3">
                                        <div className="text-base font-semibold">{user.lastName} {user.firstName}</div>                    
                                    </div>  
                                </th>
                                ...
                                <td className="px-6 py-4">
                                    {user.gender ? <FontAwesomeIcon icon={faMale} size="2xl" color="green"/> : <FontAwesomeIcon icon={faFemale} size="2xl" color="red"/>}
                                </td>
                                <td className="px-6 py-4">

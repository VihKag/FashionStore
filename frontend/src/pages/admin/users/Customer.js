...
const Customer = () => {
  ...
  const { getAllUsers, getAllCustomers, setUsers, users, setUserActive } =
    ...
    <>
      ...
      <div className="mx-auto p-8">
        <div className="flex justify-between items-center mb-4">
          <h1 className="text-3xl font-bold mb-4">Quản lí khách hàng</h1>
        </div>
        ...
        {window.location.pathname === "/admin/customers/add" && <AddUser />}
      </div>
    </>
  );
};

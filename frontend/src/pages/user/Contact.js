          ...
          <div class="container mx-auto">
            <div class="mb-5">
              <div class="breadcrumb-wrapper font-400 text-[13px] text-qblack mb-[23px]">
                <span>
                  <a href="/">
                    <span class="mx-1 capitalize">home</span>
                  </a>
                  <span class="sperator">/</span>
                </span>
                <span>
                  <a href="/contact">
                    <span class="mx-1 capitalize">contact</span>
                  </a>
                  <span class="sperator">/</span>
                </span>
              </div>
            ...
            <div class="flex justify-center">
              <h1 class="text-3xl font-semibold text-qblack">Contact</h1>
            </div>
          </div>
        </div>
      </div>
      <div class="contact-wrapper w-full mb-10">
        <div class="container mx-auto">
          <div class="main-wrapper w-full lg:flex lg:space-x-[30px] bg-white">
            <div class="lg:w-1/2 w-full p-2">
              <h1 class="text-[22px] font-semibold text-qblack leading-[30px] mb-1">
                Contact Information
              </h1>
              <p class="text-[15px] text-qgraytwo leading-[30px] mb-5">
                Fill the form below or write us .We will help you as soon as
                possible.
              </p>
              <div class="xl:flex xl:space-x-[30px] mb-[30px]">
                <div class="xl:w-1/2 w-full  h-[196px] flex flex-col item justify-center bg-[#FFEAE5] p-5">
                  ...
                  <p class="text-[22px] text-black leading-[30px] text-center font-semibold">
                    Phone
                  </p>
                  <p class="text-[15px] text-black leading-[30px] text-center">
                    +(323) 9847 3847 383
                  </p>
                  <p class="text-[15px] text-black leading-[30px] text-center">
                    +(434) 5466 5467 443
                ...
                <div class="xl:w-1/2 w-full h-[196px] flex flex-col item justify-center bg-[#D3EFFF] p-5">
                  <div class="flex justify-center mb-3 ">
                    <svg
                      width="44"
                      height="44"
        ...
        14.0012 24.5399 14.0022C23.6935 14.0025 22.8471 14.0029 22.0007 14.0029C21.8436 14.0029 21.6857 14.0029 21.5278 14.0014C20.759 14.0014 19.9902 14.001 19.2213 14.0007C17.1709 13.9998 15.1202 13.9989 13.07 14.0045C12.1288 14.0068 11.3547 14.5837 11.0936 15.4378C10.8333 16.2889 11.1213 17.1377 11.8915 17.6538C14.8862 19.6594 17.8839 21.6605 20.8901 23.6492C21.6133 24.1275 22.3766 24.1075 23.1145 23.6515C23.3977 23.4769 23.6732 23.2904 23.9487 23.104C24.0523 23.0339 24.1558 22.9638 24.2598 22.8944C24.9163 22.4566 25.5726 22.0186 26.229 21.5807C28.1545 20.2959 30.0799 19.0112 32.0082 17.7308ZM21.4417 22.8151C21.6574 22.9577 21.8376 23.0016 21.9909 23.0007C22.1486 22.9998 22.3464 22.9506 22.5888 22.8008L22.5896 22.8003C22.8536 22.6375 23.1029 22.4688 23.3716 22.287C23.4787 22.2145 23.5889 22.1399 23.7043 22.0628L23.705 22.0624C24.3607 21.6251 25.0165 21.1875 25.6725 20.7499C27.5985 19.4647 29.5255 18.179 31.4551 16.8977L31.4553 16.8976C31.8444 16.6394 31.9808 16.3923 31.9942 16.0729C32.0181 15.4929 31.5978 15.0071 30.886 15.0052M21.4417 22.8151C18.4378 20.8279 15.4419 18.8281 12.4482 16.823L21.4417 22.8151ZM12.0499 15.7302L12.0499 15.7303C11.9179 16.1618 12.0459 16.5534 12.448 16.8229M13.0727 15.0045L13.0724 15.0045C12.5581 15.0057 12.1793 15.3069 12.0499 15.7302M24.5417 15.0022C23.695 15.0025 22.848 15.0029 22.0007 15.0029H21.9984C21.8444 15.0029 21.6841 15.0029 21.523 15.0014C20.7548 15.0014 19.987 15.001 19.2194 15.0007C17.1695 14.9998 15.1212 14.9989 13.0727 15.0045M24.5417 15.0022C26.6573 15.0012 28.7714 15.0003 30.8859 15.0052L24.5417 15.0022Z"
              ...
              <div class="p-5 flex flex-col justify-between w-full bg-[#E7F2EC]">
                <div class="flex space-x-5">
                  ...
                  <div>
                    <h1 class="text-[22px] font-semibold text-qblack leading-[30px] mb-2">
                      Address
                    </h1>
                    <p class="text-[15px] text-qblack leading-[30px]">
                      4517 Washington Ave. Manchester, Road 2342, <br />
                      Kentucky 39495
                    </p>
                  </div>
                </div>
                <div class="w-full h-[206px] mt-5">
                  <iframe
                    title="newWork"
            ...
            <div class="flex-1 bg-white sm:p-10 p-3">
              <div class="title flex flex-col items-center">
                <h1 class="text-[34px] font-bold text-qblack">Get In Touch</h1>
              ...
              <div class="inputs mt-5">
                <div class="mb-4">
                  <div class="input-com w-full h-full">
                    ...
                    <div class="input-wrapper border border-qgray-border w-full h-full overflow-hidden relative ">
                      <input
                        placeholder="Demo Name"
                        class="input-field placeholder:text-sm text-sm px-6 text-dark-gray w-full font-normal bg-white focus:ring-0 focus:outline-none h-[50px]"
                        id="first_name"
                        value=""
                      />
                    </div>
                ...
                <div class="mb-5">
                  <h6 class="input-label text-qgray capitalize text-[13px] font-normal block mb-2 ">
                    Message*
                  </h6>
                  <textarea
                    placeholder="Type your message here"
                    class="w-full h-[105px] focus:ring-0 focus:outline-none p-3 border border-qgray-border placeholder:text-sm"
                  ></textarea>
                </div>
                <div>
                  <a href="/#">
                    <div class="bg-gray-900 text-sm text-white rounded-md font-semibold w-full h-[50px] flex justify-center items-center">
                      <span>Send Now</span>
                    </div>
                  </a>
                </div>
